...
return <section className='reservation' id='reservation'>
    <div className="container">
        <div className="banner">
            <img src="/bg_5.png" alt="res" />
        </div>
        <div className="banner">
            <div className="reservation_form_box">
                <h1 className="form-heading">MAKE A RESERVATION</h1>
                ...
                <form>
                    ...
                    <button type='submit' className="primaryBtn" onClick={handleReservation}>RESERVE NOW{" "} <span><HiOutlineArrowNarrowRight/></span></button>
                </form>
            </div>
        </div>
    </div>
